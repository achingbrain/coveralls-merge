...
function getHead() {
    var _getAuthorNameAndEmai = getAuthorNameAndEmail(),
        _getAuthorNameAndEmai2 = _slicedToArray(_getAuthorNameAndEmai, 2),
        author_name = _getAuthorNameAndEmai2[0],
        author_email = _getAuthorNameAndEmai2[1],
        _getCommitterNameAndE = getCommitterNameAndEmail(),
        _getCommitterNameAndE2 = _slicedToArray(_getCommitterNameAndE, 2),
        committer_name = _getCommitterNameAndE2[0],
        committer_email = _getCommitterNameAndE2[1];
